...
class Main():
	...
	def instructions(self):
		...
		self.screen.blit(instructions1,(778,300))
		self.screen.blit(instructions2,(778,331))
		self.screen.blit(instructions3,(778,362))
	...
	def _draw(self, maze, tile, player, game, clock):
		...
		if self.game_over:
			clock.stop_timer()
			self.screen.blit(game.message(),(778,120))
		else:
			clock.update_timer()
		self.screen.blit(clock.display_timer(), (778,200))
	...
	def main(self, frame_size, tile):
		...
		player = Player(PLAYER_INIT_X, PLAYER_INIT_X)
		clock = Clock()
		...
		while self.running:
			...
			self.screen.fill( pygame.Color("darkslategray"), (778, 0, 950, 950))
...
if __name__ == "__main__":
	...
	screen = (window_size[0] + 150, window_size[1]-1)
	tile_size = TILE_SIZE
